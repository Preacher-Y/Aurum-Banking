                ...
                <div className="space-y-3">
                  ...
                  <div className="aurum-input-shell">
                    <div className="aurum-input-core">
                      ...
                      <input aria-label="Password" autoComplete="new-password" className="aurum-input" placeholder="Password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required />
                    </div>
                  </div>
                  ...
                  <div className="aurum-input-shell">
                    <div className="aurum-input-core">
                      ...
                      <input aria-label="Confirm password" autoComplete="new-password" className="aurum-input" placeholder="Confirm password" type="password" value={confirm} onChange={(e) => setConfirm(e.target.value)} required />
                    </div>
                  </div>
                </div>
