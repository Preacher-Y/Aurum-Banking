                ...
                <div className="space-y-3">
                  ...
                  <div className="aurum-input-shell">
                    <div className="aurum-input-core">
                      ...
                      <input aria-label="Password" autoComplete="current-password" className="aurum-input" placeholder="Password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required />
                    </div>
                  </div>
                </div>
